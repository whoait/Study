...
namespace Gulliver.DoCol.Entities.DCW.DCW003Model
{
    public class DCW003ConditionModel : CmnPagingModel
	{
        ...
        //Add HoaVV add p2 start
        public int DocumentSrearchAA { get; set; }
        public int FlgSearchAADN { get; set; }
        //Add HoaVV add p2 end
        public int RowCount { get; set; }
        public int Mode { get; set; }
        //Add HoaVV fix bug CR84 start
        public string IsCanselflg { get; set; }
        public string NoCanselflg { get; set; }
