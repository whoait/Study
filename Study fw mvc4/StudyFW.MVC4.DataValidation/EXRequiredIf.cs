...
using StudyFW.MVC4.MessageUtility;
using System;
...
namespace StudyFW.MVC4.DataValidation
{
	public class EXRequiredIf : ConditionalAttributeBase, IClientValidatable
	{
		...
		public EXRequiredIf( string dependentProperty, object targetValue )
			: this( dependentProperty, targetValue, null )
		{
		}

		public EXRequiredIf( string dependentProperty, object targetValue, string errorMessage )
			: base( errorMessage )
		{
		...
		public EXRequiredIf( string dependentProperty, object targetValue, string msgCd, Type msgReplaceStrResourceType, string msgReplaceStrResourceName )
			: this( dependentProperty, targetValue, null )
		{
		...
		public EXRequiredIf( string dependentProperty, object targetValue, bool hasRadioButton, string msgCd, Type msgReplaceStrResourceType, string msgReplaceStrResourceName )
			: this( dependentProperty, targetValue, null )
		{
			ResourceManager resourceManager = new ResourceManager( msgReplaceStrResourceType );
			this.msgReplaceStr = resourceManager.GetString( msgReplaceStrResourceName );
		...
		public IEnumerable<ModelClientValidationRule> GetClientValidationRules( ModelMetadata metadata, ControllerContext context )
		{
			...
			{
				rule.ValidationParameters.Add( "hasradiobutton", this.hasRadioButton );
			}
		...
		protected override ValidationResult IsValid( object value, ValidationContext validationContext )
		{
			...
			if (!ShouldRunValidationNotEmpty( value, this.DependentProperty, this.TargetValue, validationContext ))
			{
