...
namespace StudyFW.MVC4.Areas.DCW.Controllers
{
    using System;
    using System.Collections.Generic;
    using System.Web.Mvc;
    using StudyFW.MVC4.Entities.DCW.DCW002Model;
    using StudyFW.MVC4.BusinessServices;
    using StudyFW.MVC4.Controllers;
    using System.IO;
    using StudyFW.MVC4.UtilityServices;
    using System.Web;
    using System.Data;
    using StudyFW.MVC4.Constants;
    using StudyFW.MVC4.ReportServices;
	using System.Text;
    ...
    public class DCW002Controller : BaseController
    {
        ...
        public ActionResult DCW002Menu()
        {
            ...
            if (cache != null)
            {
                ...
                base.RemoveCache("DCW002CheckMess");
            }
            else {
            }
        ...
        public ActionResult DCW002UploadFile(HttpPostedFileBase file, int mode, int check)
        {
            ...
            if (file != null)
            {
                ...
                {
                    var csvReader = new System.IO.StreamReader(postfile.InputStream);
                    var csvReader1 = new System.IO.StreamReader(postfile.InputStream, Encoding.GetEncoding("shift-jis"));
                    //if (csvReader.CurrentEncoding.ToString().Contains("UTF8")) {
                    //    csvReader = new System.IO.StreamReader(postfile.InputStream, Encoding.GetEncoding("shift-jis"));
                    //}
                    ...
                    if (mode == 6 && postfile.FileName.Contains(Import1.FileName))
                    {
                        ...
                        while (!csvReader1.EndOfStream && checkMess == 0)
                        {
                            string RowData = csvReader1.ReadLine().Trim();
                            if (RowData.Length > 0)
                            {
                                ...
                                if (rowCount == 0)
                                {
                                    ...
                                    try
                                    {
                                        foreach (string csvHeader1 in columnNames)
                                        {
                                            DataColumn dc = new DataColumn(csvHeader1.ToUpper(), typeof(string));
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(DataValues[0]) || string.IsNullOrEmpty(DataValues[1]) || string.IsNullOrEmpty(DataValues[2])
                                            ...
                                            || DataValues[4].Length > 25 || DataValues[5].Length > 12 || DataValues[6].Length > 1
                                            ) checkMess = 1;
                                        else dt.Rows.Add(dr);
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(DataValues[0]) || string.IsNullOrEmpty(DataValues[1]) || string.IsNullOrEmpty(DataValues[3])
                                            ...
                                            || DataValues[3].Length > 25 || DataValues[4].Length > 12 || DataValues[5].Length > 1
                                            ) checkMess = 1;
                                        else dt.Rows.Add(dr);
                    ...
                    #region Import 5
                    else if (mode == 10 && postfile.FileName.Contains(Import5.FileName))
                    {
                        ...
                        while (!csvReader.EndOfStream && checkMess == 0)
                        {
                            ...
                            if (RowData.Length > 0)
                            {
                                ...
                                if (rowCount == 0)
                                {
                                    ...
                                    if (columnNames.Length != 11) checkMess = 1;
                                    //else
                                    //{
                                    //    if (columnNames[0] != Import2.Col0 || columnNames[1] != Import2.Col1
                                    //        || columnNames[2] != Import2.Col2 || columnNames[3] != Import2.Col3
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        //if (string.IsNullOrEmpty(DataValues[0]) || string.IsNullOrEmpty(DataValues[1]) || string.IsNullOrEmpty(DataValues[2]) 
                                        //    || string.IsNullOrEmpty(DataValues[3]) || string.IsNullOrEmpty(DataValues[4]) || string.IsNullOrEmpty(DataValues[5])
                                        //    || string.IsNullOrEmpty(DataValues[6]) || string.IsNullOrEmpty(DataValues[7]) || string.IsNullOrEmpty(DataValues[8])
                                        //    || string.IsNullOrEmpty(DataValues[9]) || string.IsNullOrEmpty(DataValues[10])
                                        //    ) checkMess = 1;
                                        //else 
                                        if (DataValues[0].Length > 20 || DataValues[1].Length > 6 || DataValues[2].Length > 60
                                        || DataValues[3].Length > 40 || DataValues[4].Length > 100 || DataValues[5].Length > 25
                                        || DataValues[6].Length > 20 || DataValues[7].Length > 8 || DataValues[8].Length > 1000
                                        || DataValues[9].Length > 1000 || DataValues[10].Length > 1000
                                        ) checkMess = 1;
                                        else dt.Rows.Add(dr);
                                        lst.Add(DataValues[5]);
                                    }
                                    catch (Exception)
                                    {
                                        checkMess = 1;
                    ...
                    else if (mode == 9)
                    {
                        ...
                        //var csvReader1 = new System.IO.StreamReader(postfile.InputStream,Encoding.GetEncoding("utf-8"));
                        //var csvReader = new System.IO.StreamReader(csvReader1.BaseStream, Encoding.GetEncoding("shift-jis"));
                        //var csvReader = new System.IO.StreamReader(postfile.InputStream);
                        while (!csvReader.EndOfStream && checkMess == 0)
                        {
                            string RowData = csvReader.ReadLine().Trim();
                            if (RowData.Length > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(DataValues[0]) || string.IsNullOrEmpty(DataValues[4]))
                                        {
                                            checkMess = 1;
                                        }
