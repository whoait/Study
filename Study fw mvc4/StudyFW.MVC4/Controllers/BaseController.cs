namespace StudyFW.MVC4.Controllers
{
	using System;
	...
	using StudyFW.MVC4.BusinessServices.Common;
	using StudyFW.MVC4.Constants;
	using StudyFW.MVC4.Constants.Security;
	using StudyFW.MVC4.DataAccess.Common;
	using StudyFW.MVC4.DataValidation;
	using StudyFW.MVC4.Entities;
	using StudyFW.MVC4.Entities.Common;
	using StudyFW.MVC4.Library.Sercurity;
	...
	public class BaseController : Controller
	{
		...
		public ActionResult GetMessage( string messageId, string replaceString )
		{
			...
			{
				content = StudyFW.MVC4.UtilityServices.Utility.GetMessage( messageId, replaceString );
			}
			else
			{
				content = StudyFW.MVC4.UtilityServices.Utility.GetMessage( messageId );
			}
