namespace StudyFW.MVC4.Constants
{
	...
	public class DCW003Constant
	{
		...
		public const string DEF_RD0020_FILE = @"\DoCol\UAT\RD0020.fcp";
        public const string DEF_RD0010_FILE = @"\DoCol\UAT\RD0010.fcp";
        public const string DEF_RD0030_FILE = @"\DoCol\UAT\RD0030.fcp";
		public const string SHOHIN_TYPE_DN = "101";
		public const string SHOHIN_TYPE_AA = "201";
	}
