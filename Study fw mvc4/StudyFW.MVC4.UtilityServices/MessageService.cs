...
namespace StudyFW.MVC4.UtilityServices
{
	public static partial class Utility
	{
        ...
        public static string GetMessage(string messageID,
                                                ...
                                                out string messageContent)
        {
            messageContent = MessageService.GetMessage(messageID, replaceString1 + "\t" + replaceString2 + "\t" + replaceString3 + "\t" + replaceString4 ,out messageType);
            return messageContent;
        }
	}
}